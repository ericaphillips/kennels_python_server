...
class HandleRequests(BaseHTTPRequestHandler):
    def parse_url(self, path):
        ...
        #will have "" at index 0, "animals" at index 1, and "1" at index 2
    ...
    def do_GET(self):
        ...
        #Parse the URL and store the entire tuple in a variable
        parsed = self.parse_url(self.path)

        #Response from parse_url() is a tuple with 
        #2 items in it, which means the request was for
        ...
        #items in it, qhich means the request was for 
    ...
    def do_PUT(self):
        ...
        #Encode new animal and send in response
    ...
    def do_DELETE(self):
        ...
        #Delete a single thing from list
        if resource == "animals":
            delete_animal(id)
        if resource == "customers":
            delete_customer(id)
